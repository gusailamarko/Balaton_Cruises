const Footer = () => {
  return (
    <div className="footer text-white pt-10">
        <h3 className="text-center text-[2rem] font-bold italic">WE HOPE YOU JOIN US AT LAKE BALATON!</h3>
        <div className="flex justify-center pt-5 pb-5 gap-5">
            <a className="cursor-pointer" href="https://www.facebook.com/profile.php?id=61587377002178" target="_blank">
            ...
            <a className="cursor-pointer" href="https://www.instagram.com/balatoncruises/" target="_blank">
            ...
            <a className="cursor-pointer" href="https://www.tiktok.com/@balatoncruises" target="_blank">
